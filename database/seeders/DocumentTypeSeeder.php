    ...
    public function run(): void
    {
        $types = [
            ...
            [
                'name'                => 'Biodata',
                'code'                => 'BIODATA',
                'description'         => 'Applicant biodata document for Japan deployment screening',
                'required_fields'     => [],
                'validation_rules'    => [],
                'is_required'         => false,
                'is_active'           => true,
            ...
            // ─── NEW: ID Photo / Profile Picture ──────────────────────────────
            [
                'name'                => 'ID Photo (2x2)',
                'code'                => 'ID_PHOTO',
                'description'         => '2x2 white background picture for profile and application form',
                'required_fields'     => [],
                'validation_rules'    => [],
                'is_required'         => true,
                'is_active'           => true,
