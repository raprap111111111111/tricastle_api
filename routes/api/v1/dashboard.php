...
Route::prefix('dashboard')->name('dashboard.')->group(function () {
    ...
    Route::get('/active-batches', [DashboardController::class, 'activeBatches'])->name('active-batches');
    Route::get('/quick-stats', [DashboardController::class, 'quickStats'])->name('quick-stats');
    Route::get('/attention', [DashboardController::class, 'attention'])->name('attention');
    Route::get('/birthdays', [DashboardController::class, 'birthdays'])->name('birthdays');
});