...
class GetAllApplicantLifestyleRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('viewAny', ApplicantLifestyle::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'is_drinking_alcohol'   => ['nullable', 'boolean'],
            'is_using_drugs'        => ['nullable', 'boolean'],
            'was_smoking'           => ['nullable', 'boolean'],
            'was_drinking_alcohol'  => ['nullable', 'boolean'],
            'was_using_drugs'       => ['nullable', 'boolean'],
